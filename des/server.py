...
# Similar DES constants and tables as in the client script
...
def generate_round_keys(key):
    # Key generation logic from previous implementation
...
def main():
    ...
    # Encryption key (must match client's key)
    ...
    while True:
        ...
        # Decrypt the message
        decrypted_text = bin2hex(encrypt(encrypted_data, rkb_rev, rk_rev))
